				...
				return function(offset_y){
					if(_motion!=motion){
						...
						if('up'==motion){
							...
							sec=n_sec;
							//var none = $(".six").css("display");
							//if(none!="none"){
							//	$(".six .shortNum span").html("0");
							//	$(".six .longNum span").html("0");
							//	setTimeout(function(){
							//		var shorttimer = setInterval(function(){
							//			var short = $(".six .shortNum span").html();
							//			var numshort=parseInt(short);
							//			numshort++;
							//			$(".six .shortNum span").html(numshort);
							//			if(numshort==16){
							//				$(".six .shortNum span").html("16.5");
							...
							//			var long = $(".six .longNum span").html();
							//			var numlong=parseInt(long);
							//			numlong++;
							//			$(".six .longNum span").html(numlong);
							//			if(numlong==19){
							//				$(".six .longNum span").html("19.4");
